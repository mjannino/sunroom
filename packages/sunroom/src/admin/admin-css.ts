...
.sr-btn-primary{font-weight:600;color:var(--sr-on-accent);background:var(--sr-accent);border-color:transparent;}
...
.sr-grip{color:var(--sr-faint);font-size:14px;cursor:grab;letter-spacing:-2px;}
